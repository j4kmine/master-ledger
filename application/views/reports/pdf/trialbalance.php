				...
				<thead>
					<tr>
						<?php
							...
							echo '<th>' . lang('trial_balance_total_debit') . ' (' . $this->mAccountSettings->currency_symbol . ')' . '</th>';
							echo '<th>' . lang('trial_balance_total_credit') . ' (' . $this->mAccountSettings->currency_symbol . ')' . '</th>';
